package com.fares.stock.management.core.utils.constants.jwt;
...
import static com.fares.stock.management.core.utils.constants.constants.Constants.SECRET_KEY;
...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, ExtendedUser userDetails) {
        ...
        return Jwts.builder().setClaims(claims)
                ...
                .claim("idEnterprise", userDetails.getEnterpriseId().toString())
